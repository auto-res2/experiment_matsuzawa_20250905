...
Iteration39 update:
  • All results JSONs must be saved under
        .research/iteration39/
  • All figure files must be saved under
        .research/iteration39/images/
This file centralises those paths so that the rest of the code-base does not
...
# ---------------------------------------------------------------------------
# Directories mandated by the assessment instructions (iteration39)
# ---------------------------------------------------------------------------
_BASE_RESULTS_DIR = Path(".research/iteration39")
...
class ExperimentBase:
    ...
    def __init__(self, name: str, exp_cfg: Dict[str, Any], global_cfg: Dict[str, Any]):
        ...
        # strictly under .research/iteration39/ as required by the rubric.
    ...
    def save_line_plot(
        ...
        """Write a small line plot under .research/iteration39/images."""
