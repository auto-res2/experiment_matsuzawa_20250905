...
Iteration51 update:
  • All results JSONs must be saved under
        .research/iteration51/
  • All figure files must be saved under
        .research/iteration51/images/
...
# ---------------------------------------------------------------------------
# Directories mandated by the assessment instructions (iteration51)
# ---------------------------------------------------------------------------
_BASE_RESULTS_DIR = Path(".research/iteration51")
...
class ExperimentBase:
    ...
    def __init__(self, name: str, exp_cfg: Dict[str, Any], global_cfg: Dict[str, Any]):
        ...
        # strictly under .research/iteration51/ as required by the rubric.
    ...
    def save_line_plot(
        ...
        """Write a small line plot under .research/iteration51/images."""
