...
# ---------------------------------------------------------------------------
# Directories mandated by the assessment instructions (iteration9)
# ---------------------------------------------------------------------------
_BASE_RESULTS_DIR = Path(".research/iteration9")
...
class ExperimentBase:
    ...
    def __init__(self, name: str, exp_cfg: Dict[str, Any], global_cfg: Dict[str, Any]):
        ...
        # strictly under .research/iteration9/ as required by the rubric.
    ...
    def save_line_plot(
        ...
        """Utility that writes a small line plot under .research/iteration9/images."""
