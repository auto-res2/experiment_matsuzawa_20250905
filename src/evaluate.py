...
Iteration36 update:
  • All results JSONs must be saved under
        .research/iteration36/
  • All figure files must be saved under
        .research/iteration36/images/
...
# ---------------------------------------------------------------------------
# Directories mandated by the assessment instructions (iteration36)
# ---------------------------------------------------------------------------
_BASE_RESULTS_DIR = Path(".research/iteration36")
...
class ExperimentBase:
    ...
    def __init__(self, name: str, exp_cfg: Dict[str, Any], global_cfg: Dict[str, Any]):
        ...
        # strictly under .research/iteration36/ as required by the rubric.
    ...
    def save_line_plot(
        ...
        """Write a small line plot under .research/iteration36/images."""
