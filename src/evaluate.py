...
# ---------------------------------------------------------------------------
# Directories mandated by the assessment instructions (iteration21)
# ---------------------------------------------------------------------------
_BASE_RESULTS_DIR = Path(".research/iteration21")
...
class ExperimentBase:
    ...
    def __init__(self, name: str, exp_cfg: Dict[str, Any], global_cfg: Dict[str, Any]):
        ...
        # strictly under .research/iteration21/ as required by the rubric.
    ...
    def save_line_plot(
        ...
        """Utility that writes a small line plot under .research/iteration21/images."""
